...
//	 }
	...
	public ResponseEntity<List<AttachFileDTO>> uploadAjaxPost(MultipartFile[] uploadFile) {
		...
		String uploadFolder = "C:\\spring_file\\upload\\";
	...
	public ResponseEntity<byte[]> getFile(String fileName) {
		...
		File file = new File("C:\\spring_file\\upload\\" + fileName);
	...
	//
	// Resource resource = new FileSystemResource("C:\\spring_file\\upload\\" + fileName);
	//
	...
	public ResponseEntity<String> deleteFile(String fileName, String type) {
		...
		try {
			file = new File("C:\\spring_file\\upload\\" + URLDecoder.decode(fileName, "UTF-8"));
